...
import com.zwb.zwbmod.item.DeadCoinItem;
...
public class ZwbMod
{
    ...
    public static final String MODID = "zwb_mod";
    ...
    public static final RegistryObject<CreativeModeTab> ZWB_MOD_TAB = CREATIVE_MODE_TABS.register("zwb_mod", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                output.accept(DEAD_COIN.get()); // Add the example item to the tab. For your own tabs, this method is preferred over the event
            }).build());
